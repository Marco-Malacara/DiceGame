...
function dieThree(n){
    ...
    if(rollValue === 1){
        window.alert('Your jouney begins thourgh the woods, continue with caution...roll 12 sided die');
    }
    else if(rollValue === 2){
        window.alert('Your journey begins, you choose to sail the seas in hop of finding your destination...may luck be on your side! roll D8!');
    }
    else if(rollValue === 3){
